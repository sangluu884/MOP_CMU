...
namespace WindowsFormsApplication.Account_Management
{
    public partial class GUI_Account : Form
    {
        ...
        private void btnCreate_Click(object sender, EventArgs e)
        {
            ...
            Account checkUserName = db.Accounts.FirstOrDefault(x => x.UserName.Equals(userName));
            string password = txtPassword.Text;
            if (validation.Required(txtFullName) || validation.Required(txtAddress) || validation.Required(txtPhoneNumber) || validation.Required(txtCMND) || validation.Required(txtUserName) || validation.Required(txtPassword) || validation.RegularNumberExpression(txtPhoneNumber) || validation.RegularNumberExpression(txtCMND)||checkUserName!=null)
            {
                ...
                if (checkUserName != null) tmp += "Username existed\n";
                if (tmp != null)
                {
                    MessageBox.Show(tmp);
                }
